/* 
 * Copied From Apache Geode with minor modifications.   
 * 
 ...
 */
public class TypePreservingPdxToJSON {
  ...
  public TypePreservingPdxToJSON(PdxInstance pdx) {
    m_pdxInstance = pdx;
  }
  ...
  private String getJSONString(JsonGenerator jg, PdxInstance pdxInstance)
    ...
    jg.writeString(pdxInstance.getClassName());
